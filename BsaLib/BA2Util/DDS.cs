...
namespace BsaLib.BA2Util
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct DDS_PIXELFORMAT(uint size, uint flags, uint fourCC, uint rgbBitCount, uint rBitMask, uint gBitMask, uint bBitMask, uint aBitMask)
    {
        public uint dwSize = size;
        public uint dwFlags = flags;
        public uint dwFourCC = fourCC;
        public uint dwRGBBitCount = rgbBitCount;
        public uint dwRBitMask = rBitMask;
        public uint dwGBitMask = gBitMask;
        public uint dwBBitMask = bBitMask;
        public uint dwABitMask = aBitMask;
